/**
 * libr.c - Minimal example CLI.
 * Summary: Command line interface for the libr example library.
 *
 * Author:  KaisarCode
 ...
 * @return None.
 */
static void kc_libr_help(const char *name) {
 ...
 * @return None.
 */
static void kc_libr_print_version(void) {
...
int main(int argc, char **argv) {
    ...
    greeting = kc_libr_greet(name);
    if (!greeting) {
        fprintf(stderr, "libr: greeting failed\n");
        return 1;
    }
