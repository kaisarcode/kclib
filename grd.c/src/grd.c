...
static void kc_grd_help(const char *name) {
    ...
    printf("Options:\n");
    printf("  --width,   -w <n>      Root width in pixels (required by split and layout)\n");
    printf("  --height,  -H <n>      Root height in pixels (required by split and layout)\n");
    printf("  --x,       -x <n>      Root X position for layout (default: 0)\n");
    printf("  --y,       -y <n>      Root Y position for layout (default: 0)\n");
    printf("  --kind,    -k row|col  Split direction for split (default: row)\n");
    printf("  --weights, -W <...>    Space or comma separated split weights (required, min 2)\n");
    printf("  --gap,     -g <n>      Gap for split in pixels (default: 0)\n");
    printf("  --min,     -m <n>      Minimum split child size in pixels (default: 1)\n");
    printf("  --help,    -h          Show help\n");
    printf("  -v, --version          Show version\n\n");
    printf("Output:\n");
    printf("  split:  One line per child: index x y w h\n");
    printf("  layout: One line per box: path x y w h\n\n");
    printf("Examples:\n");
