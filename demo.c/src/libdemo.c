/**
 * libdemo.c - Minimal example library.
 * Summary: Core implementation for the demo example library.
 *
 * Author:  KaisarCode
...
#ifndef KC_DEMO_BUILD_VERSION
#define KC_DEMO_BUILD_VERSION 0
#endif
...
uint64_t kc_demo_version(void) {
    return (uint64_t)KC_DEMO_BUILD_VERSION;
}
